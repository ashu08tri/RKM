...
const Header = ({ toggleLanguage, selectedLanguage }) => {
    ...
    <header className="fixed top-0 left-0 right-0 bg-surface border-b border-border z-100 shadow-sm py-2">
      <div className="container-custom mx-auto px-2">
        <div className="flex items-center h-20 w-full">
          ...
          <Link
            to="/homepage"
            className="flex-shrink-0 p-2 mr-4 border-none"
          ...
          <button
            ...
            className="lg:hidden p-2 rounded-md hover:bg-background transition-smooth touch-target ml-auto"
